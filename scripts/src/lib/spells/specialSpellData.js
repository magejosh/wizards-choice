...
exports.getUncommonSpells = getUncommonSpells;
exports.getRareSpells = getRareSpells;
exports.getLegendarySpells = getLegendarySpells;
exports.getAllSpecialSpells = getAllSpecialSpells;
var spellData_1 = require("./spellData");
/**
 * Get all uncommon spells
 * @returns Array of uncommon spells
 */
function getUncommonSpells() {
    return [
 ...
 */
function getAllSpecialSpells() {
    return __spreadArray(__spreadArray(__spreadArray([], getUncommonSpells(), true), getRareSpells(), true), getLegendarySpells(), true);
}
// Uncommon Spells
function createEssenceTheftSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Essence Theft'),
        name: 'Essence Theft',
        type: 'damage',
        element: 'arcane',
        tier: 3,
...
function createAstralChainSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Astral Chain'),
        name: 'Astral Chain',
        type: 'damage',
        element: 'arcane',
        tier: 4,
...
function createMagneticPulseSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Magnetic Pulse'),
        name: 'Magnetic Pulse',
        type: 'damage',
        element: 'air',
        tier: 2,
...
function createResonanceStrikeSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Resonance Strike'),
...
function createHoneyedWordsSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Honeyed Words'),
        name: 'Honeyed Words',
        type: 'buff',
        element: 'arcane',
        tier: 1,
...
function createLifebloodRitualSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Lifeblood Ritual'),
...
function createElementalHarmonySpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Elemental Harmony'),
...
function createRiftShatterSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Rift Shatter'),
        name: 'Rift Shatter',
        type: 'damage',
        element: 'arcane',
        tier: 5,
...
function createChronoSkipSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Chrono Skip'),
        name: 'Chrono Skip',
        type: 'buff',
        element: 'arcane',
        tier: 4,
...
function createMirrorImageSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Mirror Image'),
        name: 'Mirror Image',
        type: 'buff',
        element: 'arcane',
        tier: 3,
...
// Rare Spells
function createEternalWinterSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Eternal Winter'),
        name: 'Eternal Winter',
        type: 'damage',
        element: 'water',
        tier: 6,
...
function createVoidRiftSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Void Rift'),
        name: 'Void Rift',
        type: 'damage',
        element: 'arcane',
        tier: 7,
...
function createSoulshatterSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Soulshatter'),
        name: 'Soulshatter',
        type: 'damage',
        element: 'arcane',
        tier: 6,
...
function createDragonflameSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Dragonflame'),
        name: 'Dragonflame',
        type: 'damage',
        element: 'fire',
        tier: 6,
...
function createCelestialBlessSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Celestial Blessing'),
...
function createAbsoluteSilenceSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Absolute Silence'),
...
function createPlasmaStormSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Plasma Storm'),
        name: 'Plasma Storm',
        type: 'damage',
        element: 'fire',
        tier: 7,
...
function createRunicBindingSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Runic Binding'),
        name: 'Runic Binding',
        type: 'buff',
        element: 'earth',
        tier: 6,
...
function createEldritchBarrierSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Eldritch Barrier'),
...
function createInsanityWhisperSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Insanity Whisper'),
...
function createWorldEndingFlameSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('World-Ending Flame'),
...
function createGazeOfTheVoidSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Gaze of the Void'),
...
function createSingularityNexusSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Singularity Nexus'),
...
function createAscendantApotheosisSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Ascendant Apotheosis'),
...
function createDivineJudgmentSpell() {
    return {
        id: (0, spellData_1.generateSpellId)('Divine Judgment'),
