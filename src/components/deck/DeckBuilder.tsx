...
import { Spell, Deck } from '../../lib/types';
...
const DeckBuilder: React.FC<DeckBuilderProps> = ({ onClose }) => {
    ...
    return (
      <div className="deck-builder">
        <div className="deck-builder__header">
          <h2>Deck Builder</h2>
          <button className="deck-builder__close-button" onClick={onClose}>×</button>
        </div>
        <div className="deck-builder__error">
          <p>Error: Player data not found. Please try again later.</p>
        </div>
      </div>
    );
  }
  ...
  useEffect(() => {
    if (decks.length === 0) {
      ...
      // Use updateWizard to update both the save slot and top-level player data
  ...
  const handleSaveDeck = () => {
    ...
    useGameStateStore.getState().updateWizard(() => updatedPlayer);
  ...
  return (
    <div className="deck-builder">
      ...
      <div className="deck-builder__decks">
        <h3>Your Decks</h3>
        ...
        {isCreatingDeck && (
          <div className="deck-builder__create-form">
            ...
            <div className="deck-builder__form-actions">
              <button
                className="deck-builder__form-button"
                onClick={handleCreateDeck}
              >
                Create
              </button>
              <button
                className="deck-builder__form-button deck-builder__form-button--cancel"
      ...
      {isEditingDeck && (
        <>
          <div className="deck-builder__editing">
            <h3>
              Editing: {getActiveDeck()?.name}
              <button
          ...
          <div className="deck-builder__filters">
            ...
            <div className="deck-builder__filter-group">
              <select className="deck-builder__filter-select" value={filter} onChange={(e) => setFilter(e.target.value)}>
            ...
            <div className="deck-builder__filter-group">
              <select className="deck-builder__filter-select" value={sortBy} onChange={(e) => setSortBy(e.target.value)}>
