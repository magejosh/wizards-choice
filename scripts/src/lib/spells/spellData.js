...
exports.generateSpellId = generateSpellId;
exports.getDefaultSpells = getDefaultSpells;
exports.getTier1Spells = getTier1Spells;
exports.getTier2Spells = getTier2Spells;
exports.getTier3Spells = getTier3Spells;
exports.getTier4Spells = getTier4Spells;
exports.getTier5Spells = getTier5Spells;
exports.getTier6Spells = getTier6Spells;
exports.getTier7Spells = getTier7Spells;
exports.getTier8Spells = getTier8Spells;
exports.getTier9Spells = getTier9Spells;
exports.getTier10Spells = getTier10Spells;
exports.getAllSpells = getAllSpells;
exports.getSpellsByTier = getSpellsByTier;
exports.getSpellsByElement = getSpellsByElement;
exports.getSpellsByType = getSpellsByType;
/**
 * Generate a unique ID for a spell
 */
function generateSpellId(name) {
    return "spell_".concat(name.toLowerCase().replace(/\s+/g, '_'), "_").concat(Date.now().toString(36));
}
/**
...
function getDefaultSpells() {
    ...
    var randomSpells = getTier1Spells()
        .filter(function (spell) { return !defaultSpells.some(function (s) { return s.name === spell.name; }); })
        .sort(function () { return Math.random() - 0.5; })
        .slice(0, 2);
    return __spreadArray(__spreadArray([], defaultSpells, true), randomSpells, true);
}
/**
 * Get all Tier 1 spells (Cantrips)
 * @returns Array of Tier 1 spells
 */
function getTier1Spells() {
    return [
        createFireboltSpell(),
        createArcaneShieldSpell(),
        createMinorHealingSpell(),
...
function getAllSpells() {
    ...
    return __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], getTier1Spells(), true), getTier2Spells(), true), getTier3Spells(), true), getTier4Spells(), true), getTier5Spells(), true), getTier6Spells(), true), getTier7Spells(), true), getTier8Spells(), true), getTier9Spells(), true), getTier10Spells(), true);
}
/**
 * Get spells by tier
 ...
 */
function getSpellsByElement(element) {
    return getAllSpells().filter(function (spell) { return spell.element === element; });
}
/**
 * Get spells by type
...
function getSpellsByType(type) {
    return getAllSpells().filter(function (spell) { return spell.type === type; });
}
// Individual spell creation functions
function createFireboltSpell() {
    return {
...
function createArcaneShieldSpell() {
    return {
...
function createMinorHealingSpell() {
    return {
...
function createArcaneBlastSpell() {
    return {
...
function createNaturesTouchSpell() {
    return {
...
function createShadowStrikeSpell() {
    return {
...
function createLightningJoltSpell() {
    return {
...
function createEarthTremorSpell() {
    return {
...
function createMysticInsightSpell() {
    return {
...
function createIceBarrierSpell() {
    return {
...
function createRejuvenationSpell() {
    return {
...
function createArcaneArmorySpell() {
    return {
...
function createVenomSpraySpell() {
    return {
...
function createThunderclaspSpell() {
    return {
...
function createEarthShieldSpell() {
    return {
...
function createNaturesBlessingSpell() {
    return {
...
function createArcaneSurgeSpell() {
    return {
...
function createEarthquakeSpell() {
    return {
...
function createShadowFormSpell() {
    return {
...
function createChainLightningSpell() {
    return {
...
function createVitalityTransferSpell() {
    return {
...
// Tier 4 Spells
function createMeteorStrikeSpell() {
    return {
...
function createArcaneExplosionSpell() {
    return {
...
function createRagingThunderstormSpell() {
    return {
...
function createNaturesWrathSpell() {
    return {
...
function createManaRejuvenationSpell() {
    return {
...
function createPhoenixFlameSpell() {
    return {
...
// Tier 5 Spells
function createSolarFlareSpell() {
    return {
...
function createAbsoluteZeroSpell() {
    return {
...
function createWorldShatterSpell() {
    return {
...
function createArcaneSingularitySpell() {
    return {
...
function createDivineRestorationSpell() {
    return {
...
function createVoidConsumptionSpell() {
    return {
...
function createElementalFusionSpell() {
    return {
...
function createEssenceOfLifeSpell() {
    return {
...
// Tier 6 Spells
function createApocalypseSpell() {
    return {
...
function createColossalEruptionSpell() {
    return {
...
function createSupercellStormSpell() {
    return {
...
function createRealityWarpSpell() {
    return {
...
function createMindControlSpell() {
    return {
...
function createPhoenixResurrectionSpell() {
    return {
...
function createTimeReverseSpell() {
    return {
...
function createCosmicShieldSpell() {
    return {
...
function createPlanarBindingSpell() {
    return {
...
function createAbyssalMawSpell() {
    return {
...
function createHurricaneApocalypseSpell() {
    return {
...
function createAstralProjectionSpell() {
    return {
...
function createElementalConvergenceSpell() {
    return {
...
function createLifeforceManipulationSpell() {
    return {
...
function createGlacialAgeSpell() {
    return {
...
function createCelestialJudgmentSpell() {
    return {
...
function createPhaseShiftSpell() {
    return {
...
// Tier 8 Spells
function createExtinctionEventSpell() {
    return {
...
function createGalacticRiftSpell() {
    return {
...
function createDimensionalCollapseSpell() {
    return {
...
function createOmniElementalFurySpell() {
    return {
...
function createCosmicRebirthSpell() {
    return {
...
function createPrimevalForceSpell() {
    return {
...
function createDivineInterventionSpell() {
    return {
...
function createRealityBreachSpell() {
    return {
...
function createTitanicManifestationSpell() {
    return {
...
// Tier 9 Spells
function createUniversalCataclysmSpell() {
    return {
...
function createEternalOblivionSpell() {
    return {
...
function createMultiversalNexusSpell() {
    return {
...
function createPrimordialGenesisSpell() {
    return {
...
function createCosmicResetSpell() {
    return {
...
function createTranscendentFormSpell() {
    return {
...
function createOmegaBlastSpell() {
    return {
...
function createCelestialMaelstromSpell() {
    return {
...
function createChronoDisruptionSpell() {
    return {
...
// Tier 10 Spells
function createTotalObliterationSpell() {
    return {
...
function createCreationExtinctionCycleSpell() {
    return {
...
function createUltimateRealitySpell() {
    return {
...
function createGodheadManifestationSpell() {
    return {
...
function createPrimordialOneSpell() {
    return {
...
function createOmnipotenceSpell() {
    return {
...
function createSingularitySpell() {
    return {
